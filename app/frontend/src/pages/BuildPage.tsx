      ...
      <div className="rounded-xl border border-slate-700 bg-slate-900 p-5">
        <div className="flex flex-wrap items-end gap-4">
          <div className="flex-1 min-w-40">
            <label htmlFor="job-select" className="mb-1 block text-xs font-medium uppercase tracking-wide text-slate-400">
              Job (optional)
            </label>
            <select
              id="job-select"
          ...
          <div>
            <label htmlFor="llm-select" className="mb-1 block text-xs font-medium uppercase tracking-wide text-slate-400">
              LLM
            </label>
            <select
              id="llm-select"
