...
const BASIC_LABELS: Record<string, { label: string; tip: string; type: 'text' | 'boolean' | 'number' }> = {
  CV_LLM_MODEL: { label: 'LLM Model', tip: 'The model identifier to use for AI bullet generation (e.g. gpt-4o, claude-3-5-sonnet).', type: 'text' },
...
const ADV_LLM_LABELS: Record<string, { label: string; tip: string }> = {
  ...
  CV_LLM_MODE: { label: 'Mode', tip: 'LLM mode: "openai" or "agents".' },
